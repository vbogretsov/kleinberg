...
коробля - расписание портов в хронологическом порядке, списко предпочтений для
портов - расписание прибытия кораблей в обратном порядке.


### 8.

Рассмотреть следующую конфигурацию:

* $m_1$: $w_2, w_1, w_3$
* $m_2$: $w_1, w_2, w_3$
* $m_3$: $w_1, w_3, w_2$
* $w_1$: $m_1, m_3, m_2$ (настоящий список: $m_1, m_2, m_3$)
* $w_2$: $m_3, m_2, m_1$
* $w_3$: $m_2, m_3, m_1$
